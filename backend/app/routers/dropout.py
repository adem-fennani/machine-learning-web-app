...
def _generate_recommendations(prediction: str, confidence: str, factors: dict) -> list[str]:
    ...
    if prediction == "High Risk":
        ...
        if has_skills_concern:
            ...
            recommendations.append("🗣️ Join communication skills development programs")
        ...
        recommendations.append("⚠️ Moderate risk detected - proactive measures recommended")
        ...
        if has_skills_concern:
            ...
            recommendations.append("🗣️ Practice presentation and collaboration skills")
        ...
        if confidence == "High":
            ...
            recommendations.append("⚠️ Low risk but stay vigilant - maintain consistent effort")
